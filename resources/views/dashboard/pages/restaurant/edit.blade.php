            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">تعديل مطعم</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive-sm">
                        <form method="post" action="{{ route('dashboard.restaurants.update', $restaurant->id) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="name" value="{{ old('name', $restaurant->name ) }}" name="name"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" id="prise" value="{{ old('prise', $restaurant->prise ) }}" name="prise"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" id="service_fees" value="{{ old('service_fees', $restaurant->service_fees ) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="location" value="{{ old('location', $restaurant->location ) }}" name="location"
                                    value="" class="form-control">
                                @error('location')
                                    <span style="color: red">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="latitude" class="form-control" name="latitude"
                                    placeholder="ادخل خط العرض الخاص بالموقع" value="{{ old('latitude', $restaurant->latitude ) }}">
                                @error('latitude')
                                    <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="longitude" class="form-control" name="longitude"
                                    placeholder="ادخل خط العرض الخاص بالموقع" value="{{ old('longitude', $restaurant->longitude ) }}">
                                @error('longitude')
                                    <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="desc" name="desc" class="form-control" rows="4">{{ old('desc', $restaurant->desc ) }}</textarea>
                                @error('desc')
                                    <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                @enderror
                                <br>
                                <img src="{{ $restaurant->image }}" alt="table-user" class="me-2 rounded-circle"
