            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">الحجوزات المقبلة</a></li>
...
@section('content')
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="header-title">الحجوزات المقبلة</h4>
                ...
                <div class="card-body">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 37px;">
                        <div class="search-box">
                            <form action="{{ route('dashboard.hotels-reservations.upcoming_reservations') }}" method="get">
    ...
    <form id="cancelForm" action="{{ route('dashboard.hotels-reservations.cancel-reservation') }}" method="POST" style="display: none;">
        @csrf
        <input type="hidden" name="reservationId" id="reservationId">
        <button type="submit" id="submitForm"></button>
    </form>

    <form id="activateForm" action="{{ route('dashboard.hotels-reservations.active-reservation') }}" method="POST" style="display: none;">
        @csrf
