            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">اضافة بانر</a></li>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">اضافة بانر جديد</h4>
                    ...
                    <div class="table-responsive-sm">
                        <form method="post" action="{{  route('dashboard.sliders.store')  }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="text_ar" name="text_ar" value="" class="form-control">
                                @error('text_ar')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="text_en" name="text_en" value="" class="form-control">
                                @error('text_en')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
