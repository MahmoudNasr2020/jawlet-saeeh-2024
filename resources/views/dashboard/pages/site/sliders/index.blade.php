                ...
                <div class="card-body">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 37px;">
                        <div class="search-box">
                            <form action="{{ route('dashboard.sliders.index') }}" method="get">
                                <div class="input-group ">
                                    <input type="text" class="form-control" name="search" onkeyup="searchTable()" placeholder="ابحث عن بانر..." id="searchInput" aria-label="ابحث عن ماركة" aria-describedby="button-addon2">
                        ...
                        <button class="btn btn-primary text-white">
                            <a class="text-white" href="{{ route('dashboard.sliders.create') }}">اضافة بانر جديدة</a>
                        </button>
                    </div>
                    ...
                    <div class="table-responsive-sm">
                        <table class="table table-striped table-centered mb-0">
                            ...
                            <tr>
                                <th>#</th>
                                <th>عنوان البانر بالعربية</th>
                                <th>عنوان البانر بالانجليزية</th>
                                <th>الصورة</th>
                                <th>تاريخ الانشاء</th>
                                <th>الاجراء</th>
                            </tr>
                                ...
                                <tr id="row-{{ $slider->id }}">
                                    ...
                                    <td>
                                        <a href="javascript:void(0);"
                                           onclick="confirmDelete('{{ route('dashboard.sliders.destroy',$slider->id) }}','{{ $slider->id }}')"
                                           class="text-reset fs-16 px-1 text-danger">
                                            <i class="ri-delete-bin-2-line" style="color: red"></i>
                                        </a>

                                        <a href="{{ route('dashboard.sliders.edit',$slider->id) }}" class="text-reset fs-16 px-1 text-primary">
