            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">اضافة خدمة</a></li>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">اضافة خدمة جديد</h4>
                    ...
                    <div class="table-responsive-sm">
                        <form method="post" action="{{  route('dashboard.services.store')  }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="name_ar" name="name_ar" value="" class="form-control">
                                @error('name_ar')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="name_en" name="name_en" value="" class="form-control">
                                @error('name_en')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="text_ar" name="text_ar" class="form-control" rows="4"></textarea>
                                @error('text_ar')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="text_en" name="text_en" class="form-control" rows="4"></textarea>
                                @error('text_en')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
