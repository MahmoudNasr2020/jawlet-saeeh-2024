            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">حجوزات الطيران</li>
                ...
                <div class="card-body">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 37px;">
                        <div class="search-box">
                            <form action="{{ route('dashboard.flight-reservations.current_reservations') }}" method="get">
                                <div class="input-group ">
                                    <input type="text" class="form-control" name="search" onkeyup="searchTable()"  value="{{ request('search') }}"
                                           placeholder="ابحث عن حجز..." id="searchInput" aria-label="ابحث عن حجز"
