...
@section('content')
    ...
    <tr>
        <td class="paragraph" style="text-align: center; direction: rtl;font-size: 18px;color: green">
    ...
    <tr>
        <td class="paragraph" style="text-align: right;direction: rtl;font-weight: bold">
            اللوكيشن:
            <a href="https://www.google.com/maps/search/?api=1&query={{ $reservation->hotel->latitude }},{{ $reservation->hotel->longitude }}" target="_blank">عرض على الخريطة</a>
        </td>
    </tr>
