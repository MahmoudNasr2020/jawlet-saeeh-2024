            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0);">تعديل فندق</a></li>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">تعديل الفندق - {{ $hotel->name }}</h4>
                ...
                <div class="card-body">
                    <div class="table-responsive-sm">
                        <form method="post" action="{{ route('dashboard.hotels.update',$hotel->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <!-- حقل اسم السيارة -->
                            <div class="mb-3">
                                <label for="car_name" class="form-label">اسم الفندق</label>
                                <input type="text" id="name" class="form-control" name="name" placeholder="ادخل اسم الفندق" value="{{ $hotel->name }}">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" id="price_per_day" class="form-control" name="price_per_day" value="{{ $hotel->price_per_day }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" id="service_fees" class="form-control" name="service_fees" value="{{ $hotel->service_fees  }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="location" class="form-control" name="location" placeholder="ادخل موقع السيارة" value="{{ $hotel->location  }}">
                                @error('location')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="latitude" class="form-control" name="latitude" placeholder="ادخل خط العرض الخاص بالموقع" value="{{ $hotel->latitude }}">
                                @error('latitude')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="longitude" class="form-control" name="longitude" placeholder="ادخل خط العرض الخاص بالموقع" value="{{ $hotel->longitude }}">
                                @error('longitude')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" class="form-control" placeholder="ادخل الوصف" rows="5">{{ $hotel->description }}</textarea>
                                @error('description')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                @enderror
                                <br>
                                <img src="{{ $hotel->image }}" alt="table-user" class="me-2 rounded-circle" style="width: 100px;height: 100px;display: none" />
                            </div>
                                ...
                                <div class="form-group">
                                    <div data-repeater-list="kt_docs_repeater_basic">
                                        @if(!empty($hotel->public_utility))
                                            @foreach ($hotel->public_utility as $index => $item)
                                                <div data-repeater-item>
                                                    <div class="form-group row" dir="rtl" >
                                                        <div class="col-md-3">
                                                            <label class="form-label">الاسم</label>
                                                            <input type="text" name="kt_docs_repeater_basic[{{ $index }}][public_utility_name]" class="form-control mb-2 mb-md-0" placeholder="ادخل الاسم" style="direction: rtl" value="{{ $item['name'] }}" />
                                                        ...
                                                        <div class="col-md-3">
                                                            <img src="{{ $item['image'] }}" class="me-2 rounded-circle" alt="" style="width: 100px;height: 100px;">
                                                        </div>
                                                    </div><br>
                                                </div>
                                            @endforeach
                                            ...
                                            @foreach (old('kt_docs_repeater_basic', ['']) as $index => $oldRepeater)
                                                <div data-repeater-item>
                                                    <div class="form-group row" dir="rtl" >
                                                        <div class="col-md-3">
                                                            <label class="form-label">الاسم</label>
                                                            <input type="text" name="kt_docs_repeater_basic[{{ $index }}][public_utility_name]" class="form-control mb-2 mb-md-0"
                                                                   placeholder="ادخل الاسم" style="direction: rtl" value="{{ old('kt_docs_repeater_basic.'.$index.'.public_utility_name') }}" />
                                                            @if($errors->has('kt_docs_repeater_basic.'.$index.'.public_utility_name'))
                                                                <span style="color: red">{{ $errors->first('kt_docs_repeater_basic.'.$index.'.public_utility_name') }}</span>
                                                            @endif
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="file" id="example-fileinput" class="form-control"
                                                                   name="kt_docs_repeater_basic[{{ $index }}][public_utility_image]">
                                                            @if($errors->has('kt_docs_repeater_basic.'.$index.'.public_utility_image'))
                                                                <span style="color: red">{{ $errors->first('kt_docs_repeater_basic.'.$index.'.public_utility_image') }}</span>
                                                            @endif
                                                        </div>
