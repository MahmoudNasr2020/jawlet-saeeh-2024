                ...
                <div class="card-body">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 37px;">
                        <div class="search-box">
                            <form action="{{ route('dashboard.rental-car-cities.index') }}" method="get">
                                <div class="input-group ">
                                    <input type="text" class="form-control" name="search" onkeyup="searchTable()" placeholder="ابحث عن مدينة..." id="searchInput"
                                           aria-label="ابحث عن مدينة" aria-describedby="button-addon2">
                        ...
                        <button class="btn btn-primary text-white">
                            <a class="text-white" href="{{ route('dashboard.rental-car-cities.create') }}">اضافة مدينة جديدة</a>
                        </button>
                    </div>
                                ...
                                <tr id="row-{{ $city->id }}">
                                    ...
                                    <td>
                                        <a href="javascript:void(0);"
                                           onclick="confirmDelete('{{ route('dashboard.rental-car-cities.destroy',$city->id) }}','{{ $city->id }}')"
                                           class="text-reset fs-16 px-1 text-danger">
                                            <i class="ri-delete-bin-2-line" style="color: red"></i>
                                        </a>

                                        <a href="{{ route('dashboard.rental-car-cities.edit',$city->id) }}" class="text-reset fs-16 px-1 text-primary">
